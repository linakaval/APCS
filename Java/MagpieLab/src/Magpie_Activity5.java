...
public class Magpie_Activity5
{
	...
	public String getResponse(String statement)
	{
		...
		{
			statement = statement.replaceAll("I want", "");
			statement = statement.replaceAll(".", "");
			response = "Would you really be happy if you had" + statement + "?";
		}
		else if (findKeyword(statement, "I", 0) >= 0 &&
				findKeyword(statement, "you", 0) >= 0)
		{
			statement = statement.replaceAll("I", "");
			statement = statement.replaceAll("you", "");
			statement = statement.replaceAll(".", "");
	...
	{
		String[] responses = {"Interesting, tell me more.", "Hmmm.", "Do you really think so?", "You don't say.", "I guess.", "Oh?", "Cool.", "Sure.", "Really?", "That's chill."};

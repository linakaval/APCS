...
public class Magpie_Activity2
{
	...
	public String getResponse(String statement)
	{
		...
		else if (statement.indexOf("McKain") >= 0
				|| statement.indexOf("Dave") >= 0
				|| statement.indexOf("mccoon") >= 0)
		{
		...
		else if (statement.indexOf("Nyquil") >= 0
				|| statement.indexOf("nyquil") >= 0)
		{
